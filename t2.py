        ...
        if result.val()==1:
            try:
                ...
                if light.val() == 0 :
                    ...
                    print("LDR 2 : ",rc_time(pin_to_circuit))
                        ...
                        if compost.val() == 0:
                            if checksoil.val() == 0:
                                if values1 <= int(opens.val()):
                                    ...
                                    db.child("CARD3").update({"CHECKSOIL": 1})
                                if values1 >= int(closes.val()):
                                    ...
                                    db.child("CARD3").update({"CHECKSOIL": 0})
                        else:                
                            GPIO.output(gpio_1, False)
                            GPIO.output(gpio_4, False)
                            GPIO.output(gpio_2, True)
    ...
    while True:
        ...
        if result.val()==1:
            ...
            if hh%8==0 and mm == '00':
                ...
                image = cam.get_image()    
                pygame.image.save(image,'picture2.jpg')
                cam.stop()
                storage = firebase.storage()
                storage.child("picture").child("picture2.jpg").put("picture2.jpg")
                #time.sleep(5)
                time.sleep(60)
    ...
    while True:
        ...
        if result.val()==1:
            if photo.val() == 1:
                ...
                storage = firebase.storage()
                storage.child("picture").child("picture2.jpg").put("picture2.jpg")
                #storage.child("picture").child("outputp2.png").put("outputp2.png")
        ...
        if result.val()==1:
            if hh%10==0 and mm == '00':
                if modeGrow.val()==1:
                    ...
                    cv2.imwrite('outputp2.png',frame)
